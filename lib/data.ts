...
export const CAMPS: Camp[] = [
  {
    ...
    description:
      "The Open Cottage is our newest and most distinctive stay — a solid wooden cabin built to open straight out onto the valley. Four real walls, a proper bed and a private deck mean you get the comfort of a room with the immediacy of the outdoors. Warm and snug in the evenings, flooded with light at dawn, it's made for travellers who want the mountains close but the night cosy.",
  ...
  },
  {
    ...
    blurb: "Our finest tent. Plush bedding, an ensuite view and complimentary meals with a private bonfire.",
    description:
      "The Swiss Luxury Camp is the most indulgent way to spend a night with us. Expect plush bedding, an ensuite setup and an uninterrupted view of the valley from your tent. Complimentary meals and a private bonfire are part of the deal — all you have to do is settle in and watch the light change over the Dhauladhars.",
  ...
  },
  {
    ...
    tag: "Popular",
    image: "/photos/Bell-Camp-Bir-Billing.png",
    blurb: "A romantic canvas bell tent with dinner, bonfire and breakfast laid on. Wake to the river.",
    description:
      "Our Bell Camp is a romantic canvas bell tent that comes with dinner, a bonfire and breakfast included. It's the easy choice for couples and first-timers — comfortable, characterful and close to the riverbank, so you wake to the sound of mountain water.",
  ...
  },
  {
    ...
    blurb: "Spacious and breezy with extra bedding on request — the easy-going classic of the valley.",
    description:
      "The Swiss Camp is our easy-going classic — spacious, breezy and comfortable, with extra bedding available on request. A dependable, roomy stay with the same valley view that every camp here enjoys.",
  ...
  },
  {
    ...
    blurb: "A cosy two-person tent for travellers who like to keep it simple and close to the ground.",
    description:
      "The Safari Camp is a cosy two-person tent for travellers who like to keep things simple and stay close to the ground. Light on the wallet, big on the view — a clean, comfortable base for a weekend of flying and walking.",
  ...
  },
  {
    ...
    image: "/photos/Dormitory-Camp-Bir-Billing.png",
    blurb: "Shared sleeping under canvas — made for groups, riders and friends made on the road.",
    description:
      "Our Dormitory is shared sleeping under canvas, with eight beds available — made for groups, riders and the friends you make on the road. The most sociable way to stay, and a favourite with biker groups passing through Bir.",
  ...
  },
  {
    ...
    tag: "Best value",
    image: "/photos/Dome-Camp-Bir-Billing.png",
    blurb: "Our most affordable nest under the pines, with clean shared washrooms close by.",
    description:
      "The Dome Camp is our most affordable nest under the pines, with clean shared washrooms close by. Compact, snug and budget-friendly — proof that you don't need to spend much to wake up in the Himalayas.",
